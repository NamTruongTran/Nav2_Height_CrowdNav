 ...
 */
 ...
 #include "nav2py_height_crowdnav_controller/height_crowdnav_controller.hpp"
 ...
 namespace nav2py_height_crowdnav_controller
 {
   ...
   const std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
 {
   ...
   // Initialize nav2py
   std::string nav2py_script = ament_index_cpp::get_package_share_directory("nav2py_height_crowdnav_controller") + "/../../lib/nav2py_height_crowdnav_controller/nav2py_run" ;
   ...
   RCLCPP_INFO(
     logger_,
     "Configured controller: %s of type nav2py_height_crowdnav_controller::HeightCrowdNavController",
     plugin_name_.c_str());
 }
  ...
  const geometry_msgs::msg::Twist & velocity)
{
 ...
 void HeightCrowdNavController::cleanup()
 {
   RCLCPP_INFO(
     logger_,
     "Cleaning up controller: %s of type nav2py_height_crowdnav_controller::HeightCrowdNavController",
     plugin_name_.c_str());
   nav2py_cleanup();
   global_pub_.reset();
 }
 ...
 void HeightCrowdNavController::activate()
 {
   RCLCPP_INFO(
     logger_,
     "Activating controller: %s of type nav2py_height_crowdnav_controller::HeightCrowdNavController\"  %s",
 ...
 void HeightCrowdNavController::deactivate()
 {
   RCLCPP_INFO(
     logger_,
     "Dectivating controller: %s of type nav2py_height_crowdnav_controller::HeightCrowdNavController\"  %s",
     plugin_name_.c_str(),plugin_name_.c_str());
  ...
  nav2_core::GoalChecker * goal_checker)
{
 ...
 PLUGINLIB_EXPORT_CLASS(nav2py_height_crowdnav_controller::HeightCrowdNavController, nav2_core::Controller)